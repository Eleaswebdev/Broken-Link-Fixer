...
class BROKLIFI_Admin_Settings {
	public function __construct() {
		...
		add_action( 'admin_post_unlink_broken_link', array( $this, 'handle_single_unlink' ) );
		add_action( 'admin_post_bulk_unlink_broken_links', array( $this, 'handle_bulk_unlink' ) );
	}
